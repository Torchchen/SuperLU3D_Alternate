...
typedef struct //LUstruct_gpu_ 
{
    ...
    double **LnzvalVec_host;  // buffer host memory
    double **UnzvalVec_host;  // buffer host memory
    int_t *isGPUUsed_Lnzval_bc_ptr;
    int_t *isGPUUsed_Unzval_br_ptr;
    int_t *isGPUUsed_Lnzval_bc_ptr_host;
    int_t *isGPUUsed_Unzval_br_ptr_host;
    int_t *isCPUUsed_Lnzval_bc_ptr;  // whether iLnzval_bc_ptr backup in host memory
    int_t *isCPUUsed_Unzval_br_ptr;  // whether iUnzval_br_ptr backup in host memory
    int_t *isCPUUsed_Lnzval_bc_ptr_host;
    int_t *isCPUUsed_Unzval_br_ptr_host;
    int_t *Lnzval_bc_ptr_ilen;
    int_t Lnzval_bc_ptr_len;  // the length of Lnzval_bc_ptr in device memory
    int_t *Unzval_br_ptr_ilen; 
    int_t Unzval_br_ptr_len;  // the length of Unzval_br_ptr in device memory 
    int isEmpty;
    double *testdata;
    int_t len_max; 
    int_t pretopoLvl_Lnzval, pretopoLvl_Unzval;
    int_t prek0_Lnzval, prek0_Unzval;
    int_t nexttopoLvl_Lnzval, nexttopoLvl_Unzval;
    int_t nextk0_Lnzval, nextk0_Unzval;
    int_t pre_lrecordid, pre_urecordid;
    int_t **UsedOrder_Lnzval, **UsedOrder_Unzval;
...
#ifdef SuperLargeScaleGPUBuffer
extern int dfree_LUstruct_gpu_Buffer (dLUstruct_gpu_t * A_gpu);
#endif
