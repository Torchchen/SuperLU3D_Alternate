...
void dLUstructInit(const int_t n, dLUstruct_t *LUstruct)
{
    ...
    LUstruct->Llu->isRecordingForGPU = 0;
    #endif
    #endif
}
...
#ifdef Torch
/*! \brief Destroy distributed L & U matrices: Lrowind_bc_ptr, Lnzval_bc_ptr, Ufstnz_br_ptr, Unzval_br_ptr */
void
dDestroy_LU1(int_t n, gridinfo_t *grid, dLUstruct_t *LUstruct)
{
    int_t i, nb, nsupers;
    Glu_persist_t *Glu_persist = LUstruct->Glu_persist;
    dLocalLU_t *Llu = LUstruct->Llu;
