...
#define Torch
#ifdef Torch
    #define CPUMemLimit 15.0 // max memory is 1.0G
    #define Unused 0
    #define Used 1
    #define Changed 2
    #define MaxBuffer 1000
    #define SetVectorStatus(VectorStatus,sta) VectorStatus = /*VectorStatus - VectorStatus % 10 +*/ sta
    #define GetVectorStatus(VectorStatus) (VectorStatus/* % 10*/)
    // #undef SuperLargeScale
    // #define SuperLargeScale
        ...
        // #define SuperLargeScale_limit
            
        // #endif
    #define MINSAVESTEP 10000
    #define INDEX_Lnzval_bc_ptr 2000
    #define INDEX_Unzval_br_ptr 3000
    #define INDEXTEST_Lnzval_bc_ptr 4000
    #define INDEXTEST_Unzval_br_ptr 5000
    #define INDEX_Lnzval_RecordMatrix 6000
    #define INDEX_Unzval_RecordMatrix 7000
    #define LNZVAL_RECORDMATRIX(M,N,L,K) (*(*(*(Llu->Lnzval_RecordMatrix[M]+N)+L)+K))
    #define UNZVAL_RECORDMATRIX(M,N,L,K) (*(*(*(Llu->Unzval_RecordMatrix[M]+N)+L)+K))
    #define LNZVAL_RECORDVECTOR(M,N,L) (*(*(Llu->Lnzval_RecordMatrix[M]+N)+L))
    #define UNZVAL_RECORDVECTOR(M,N,L) (*(*(Llu->Unzval_RecordMatrix[M]+N)+L))    
    #define nPart 1
    #define testn 50

    // #define SuperLargeScaleGPU
        ...
        // #define CPUUnused 3
        // #define CPUUsed 4
        // #define GPUMemLimit 8e9
        // #define RecordingForGPU 1
        // #define LoadedRecordForGPU 2
        // #undef SuperLargeScaleGPUBuffer
        // #endif

    // #undef SuperLargeScaleGPUBuffer
    #define SuperLargeScaleGPUBuffer
        ...
        #define CPUUnused 3
        #define CPUUsed 4
        #undef SuperLargeScaleGPU
        #define SuperLargeScaleGPUByTurn
        #endif
    // #define test0101
    // #define test0103
    // #define SuperLargeScaleGPU_0109
    // #define test_0111
    // #define Torch_0121
    // #define test_0124
    // #define test_0308
    ...
    #define Torch_ReplaceTinyPivot
    #define Torch_pdgstrf2
    // #define test_0318

    // #define FILE_TXT
    #define FILE_BINARY
    #define FILE_BINARY_MATLAB

    // #define Torch_0320

    #define perm_c_index 10000

    #define TEST_DATA_DIR "/home/412-23/test/superlu_test/data22/"
    // #define TEST_DATA_DIR "/home/412-23/collision_model22/data/"

    // #define SOLVE_1
    // #define SOLVE_2

    // #define Torch_0414
    // #define Torch_smach_dist
    #define Torch_dmach_dist
    #define Torch_0419_Case2
    // #define Torch_SymPattern
    #define Torch_MAX_TREE_ALLOWED
    // #define Torch_batch_init
    #define Torch_stat
...
typedef struct {
    ...
    #ifdef SuperLargeScaleGPU
    int_t ***Lnzval_RecordMatrix[2];
    int_t ***Unzval_RecordMatrix[2];
    int_t ilvl;
    int_t topoLvl;
    int_t isRecordingForGPU;
    double MaxGPUMemory;
    double LimitGPUMemory;
    double lmemory;
    double umemory;
    double ilmemory, ilmemory_increase;
    double iumemory, iumemory_increase;

    int_t *isUsed_Lnzval_bc_ptr_Record;
    int_t *isUsed_Unzval_br_ptr_Record;
    #endif

    #ifdef SuperLargeScaleGPUBuffer
    int_t *Lrowind_bc_ptr_ilen;
...
extern int     sp_dgemv_dist_test (char *, double, SuperMatrix *, double *,
			      int, double, double *, int);
...
#ifdef Torch
extern void load_ddata_markders_vector_txt(double *data,int_t n,int_t ntimestep,int_t index);
extern void load_idata_markders_vector_txt(int_t *data,int_t n,int_t ntimestep,int_t index);
extern void load_idata_vector_txt(int_t *data,int_t n,int_t ntimestep,int_t index);
...
extern void load_idata_vector_binary_c(int_t *data,int_t n,int_t ntimestep,int_t index);
extern void load_ddata_vector_binary(double *data,int_t n,int_t ntimestep,int_t index);
...
#ifdef SuperLargeScale
extern void save_LUstruct_txt(int_t n, gridinfo3d_t *grid3d, dLUstruct_t *LUstruct);
extern void dDestroy_LU1(int_t n, gridinfo_t *grid, dLUstruct_t *LUstruct);

extern double* load_Lnzval_bc_ptr(int_t ljb, dLocalLU_t *Llu);
extern double* load_Unzval_br_ptr(int_t lb, dLocalLU_t *Llu);
extern int set_iLnzval_bc_ptr_txt(double *lsub, int_t ljb, int_t begin, int_t len, dLocalLU_t *Llu);
extern int set_iUnzval_br_ptr_txt(double *uval, int_t lb, int_t begin, int_t len, dLocalLU_t *Llu);

// every l vector to save for testing
extern void save_nLUstruct_txt(int_t n, gridinfo3d_t *grid3d, dLUstruct_t *LUstruct, int_t l);
// Load LUstruct from txt to test
extern int load_LUstruct_test(int_t n, gridinfo3d_t *grid3d, dLUstruct_t *LUstruct, int_t l);
extern void save_Changed_LUstruct_txt(int_t n, gridinfo3d_t *grid3d, dLUstruct_t *LUstruct);
#endif
...
extern int_t dblock_gemm_scatterBottomRight_predict( int_t lb,  int_t j,
                                     HyP_t* HyP,
...
extern void
dblock_gemm_scatter_predict( int_t lb, int_t j,
                    Ublock_info_t *Ublock_info,
                    Remain_info_t *Remain_info,
...
extern void  dreadhb_dist (int, FILE *, int_t *, int_t *, int_t *,
			   double **, int_t **, int_t **);
extern void dreadhb_dist2(int, int_t*, int_t*, int_t*,
	     double **, int_t **, int_t **, double **, int_t*);
extern void dreadhb_dist3(int, int_t *, int_t *, int_t *, double **, double **, int_t *);
...
extern int dcreate_matrix_postfix3d2(SuperMatrix *A, SuperMatrix *GA, int nrhs, double **rhs,
                           int *ldb, int *ldx, char * postfix, gridinfo3d_t *grid3d, int_t *ntimestep);
extern int dcreate_matrix_postfix3d3(SuperMatrix *A, SuperMatrix *GA, int nrhs, double **rhs,
                           int *ldb, int *ldx, char * postfix, gridinfo3d_t *grid3d, int_t *ntimestep);
...
#ifdef Torch
extern int_t dIBcast_LPanel_Lsub (int_t k, int_t k0, int_t* lsub,
			     gridinfo_t *, int* msgcnt, MPI_Request *,
			     int **ToSendR, int_t *xsup, int );
extern int_t dIBcast_LPanel_Lval (int_t k, int_t k0, int_t* lsub, double* lusup,
			     gridinfo_t *, int* msgcnt, MPI_Request *,
			     int **ToSendR, int_t *xsup, int );
extern int_t idIBcast_LPanel (int_t k, int_t k0, int_t* lsub, double* lusup,
			     gridinfo_t *, int* msgcnt, MPI_Request *,
			     int **ToSendR, int_t *xsup, int, int_t );
#endif
...
extern int_t dIBcast_UPanel(int_t k, int_t k0, int_t* usub, double* uval,
			    ...
			    int *ToSendD, int );
#ifdef Torch
extern int_t dIBcast_UPanel_Usub(int_t k, int_t k0, int_t* usub,
			    gridinfo_t *, int* msgcnt, MPI_Request *,
			    int *ToSendD, int );
extern int_t dIBcast_UPanel_Uval(int_t k, int_t k0, int_t* usub, double* uval,
			    gridinfo_t *, int* msgcnt, MPI_Request *,
			    int *ToSendD, int );  
extern int_t idIBcast_UPanel(int_t k, int_t k0, int_t* usub, double* uval,
			    gridinfo_t *, int* msgcnt, MPI_Request *,
			    int *ToSendD, int, int_t );              
...
#ifdef Torch
extern int_t dIrecv_LPanel_Lsub (int_t k, int_t k0,  int_t* Lsub_buf, 
			    gridinfo_t *,
			    MPI_Request *, dLocalLU_t *, int);
extern int_t dIrecv_LPanel_Lval (int_t k, int_t k0,  int_t* Lsub_buf, 
			    double* Lval_buf, gridinfo_t *,
			    MPI_Request *, dLocalLU_t *, int);
extern int_t idIrecv_LPanel (int_t k, int_t k0,  int_t* Lsub_buf, 
			    double* Lval_buf, gridinfo_t *,
			    MPI_Request *, dLocalLU_t *, int, int_t, int *msgcnt );
#endif

extern int_t dRecv_LPanel(int_t k, int_t k0,  int_t* Lsub_buf, double* Lval_buf,
 gridinfo_t *grid, MPI_Request *, dLocalLU_t *Llu, int tag_ub );
extern int_t dIrecv_UPanel(int_t k, int_t k0, int_t* Usub_buf, double*,
			   dLocalLU_t *, gridinfo_t*, MPI_Request *, int);
#ifdef Torch
extern int_t dIrecv_UPanel_Usub(int_t k, int_t k0, int_t* Usub_buf,
			   dLocalLU_t *, gridinfo_t*, MPI_Request *, int);
extern int_t dIrecv_UPanel_Uval(int_t k, int_t k0, int_t* Usub_buf, double*,
			   dLocalLU_t *, gridinfo_t*, MPI_Request *, int);   
extern int_t idIrecv_UPanel(int_t k, int_t k0, int_t* Usub_buf, double*,
			   dLocalLU_t *, gridinfo_t*, MPI_Request *, int, int_t, int *msgcnt );            
#endif
extern int_t dRecv_UPanel(int_t k, int_t k0, int_t* Usub_buf, double* Uval_buf, dLocalLU_t *Llu, gridinfo_t* grid, MPI_Request *, int tag_ub );
...
extern int_t dDiagFactIBCast(int_t k,  int_t k0,
			     ...
			     SCT_t *, int tag_ub);
#ifdef Torch
extern int_t dLDiagFactIBCast(int_t k,  int_t k0,
			     double *BlockUFactor, double *BlockLFactor,
			     int_t* IrecvPlcd_D, MPI_Request *, MPI_Request *,
			     MPI_Request *, MPI_Request *, gridinfo_t *,
			     superlu_dist_options_t *, double thresh,
			     dLUstruct_t *LUstruct, SuperLUStat_t *, int *info,
			     SCT_t *, int tag_ub);
extern int_t idLDiagFactIBCast(int_t k,  int_t k0,
			     double *BlockUFactor, double *BlockLFactor,
			     int_t* IrecvPlcd_D, MPI_Request *, MPI_Request *,
			     MPI_Request *, MPI_Request *, gridinfo_t *,
			     superlu_dist_options_t *, double thresh,
			     dLUstruct_t *LUstruct, SuperLUStat_t *, int *info,
			     SCT_t *, int tag_ub, int_t i);
extern int_t dUDiagFactIBCast(int_t k,  int_t k0,
			     double *BlockUFactor, double *BlockLFactor,
			     int_t* IrecvPlcd_D, MPI_Request *, MPI_Request *,
			     MPI_Request *, MPI_Request *, gridinfo_t *,
			     superlu_dist_options_t *, double thresh,
			     dLUstruct_t *LUstruct, SuperLUStat_t *, int *info,
			     SCT_t *, int tag_ub);
extern int_t idUDiagFactIBCast(int_t k,  int_t k0,
			     double *BlockUFactor, double *BlockLFactor,
			     int_t* IrecvPlcd_D, MPI_Request *, MPI_Request *,
			     MPI_Request *, MPI_Request *, gridinfo_t *,
			     superlu_dist_options_t *, double thresh,
...
extern int_t dIBcastRecvLPanel(int_t k, int_t k0, int* msgcnt,
			      ...
			      SCT_t *, int tag_ub);
#ifdef Torch
extern int_t dIBcastRecvLPanel_Lsub(int_t k, int_t k0, int* msgcnt,
			       MPI_Request *, MPI_Request *,
			       int_t* Lsub_buf, double* Lval_buf,
			      int_t * factored, gridinfo_t *, dLUstruct_t *,
			      SCT_t *, int tag_ub);
extern int_t dIBcastRecvLPanel_Lval(int_t k, int_t k0, int* msgcnt,
			       MPI_Request *, MPI_Request *,
			       int_t* Lsub_buf, double* Lval_buf,
			      int_t * factored, gridinfo_t *, dLUstruct_t *,
			      SCT_t *, int tag_ub);
extern int_t idIBcastRecvLPanel(int_t k, int_t k0, int* msgcnt,
			       MPI_Request *, MPI_Request *,
			       int_t* Lsub_buf, double* Lval_buf,
			      int_t * factored, gridinfo_t *, dLUstruct_t *,
			      SCT_t *, int tag_ub, int_t i);
extern int_t dIBcastRecvLPanel0(int_t k, int_t k0, int* msgcnt,
			       MPI_Request *, MPI_Request *,
			       int_t* Lsub_buf, double* Lval_buf,
			      int_t * factored, gridinfo_t *, dLUstruct_t *,
			      SCT_t *, int tag_ub);
extern int_t dIBcastLPanel(int_t k, int_t k0, int* msgcnt,
			       MPI_Request *, MPI_Request *,
			       int_t* Lsub_buf, double* Lval_buf,
			      int_t * factored, gridinfo_t *, dLUstruct_t *,
			      SCT_t *, int tag_ub);
extern int_t dIRecvLPanel(int_t k, int_t k0, int* msgcnt,
			       MPI_Request *, MPI_Request *,
			       int_t* Lsub_buf, double* Lval_buf,
			      int_t * factored, gridinfo_t *, dLUstruct_t *,
			      SCT_t *, int tag_ub);
...
#ifdef Torch
extern int_t dIBcastRecvUPanel_Usub(int_t k, int_t k0, int* msgcnt, MPI_Request *,
			       MPI_Request *, int_t* Usub_buf, double* Uval_buf,
			       gridinfo_t *, dLUstruct_t *, SCT_t *, int tag_ub);
extern int_t dIBcastRecvUPanel_Uval(int_t k, int_t k0, int* msgcnt, MPI_Request *,
			       MPI_Request *, int_t* Usub_buf, double* Uval_buf,
			       gridinfo_t *, dLUstruct_t *, SCT_t *, int tag_ub);   
extern int_t idIBcastRecvUPanel(int_t k, int_t k0, int* msgcnt, MPI_Request *,
			       MPI_Request *, int_t* Usub_buf, double* Uval_buf,
			       gridinfo_t *, dLUstruct_t *, SCT_t *, int tag_ub, int_t i); 
extern int_t dIBcastRecvUPanel0(int_t k, int_t k0, int* msgcnt, MPI_Request *,
			       MPI_Request *, int_t* Usub_buf, double* Uval_buf,
			       gridinfo_t *, dLUstruct_t *, SCT_t *, int tag_ub);    
extern int_t dIBcastUPanel(int_t k, int_t k0, int* msgcnt, MPI_Request *,
			       MPI_Request *, int_t* Usub_buf, double* Uval_buf,
			       gridinfo_t *, dLUstruct_t *, SCT_t *, int tag_ub);  
extern int_t dIRecvUPanel(int_t k, int_t k0, int* msgcnt, MPI_Request *,
			       MPI_Request *, int_t* Usub_buf, double* Uval_buf,
			       gridinfo_t *, dLUstruct_t *, SCT_t *, int tag_ub);         
#endif
