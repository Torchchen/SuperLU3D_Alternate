...
int_t* getMyTopOrder(int_t nnodes, int_t* myPerm, int_t* myIperm, int_t* setree, int_t nsupers )
{
	if (nnodes < 0) return NULL;
                                 ...
                                 int_t* myPerm, int_t* setree)
{
	...
	int_t* myTopOrder =  getMyTopOrder(nnodes, myPerm, myIperm, setree, nsupers );
	ttI.myIperm = myIperm;
