...
typedef struct {
    ...
    // #ifdef SuperLargeScale
    // gridsaveinfo_t gridsave;
    // int_t nSave; // number of process to save
    // #endif
} gridinfo3d_t;
...
extern int_t* getMyTopOrder(int_t nnodes, int_t* myPerm, int_t* myIperm, int_t* setree, int_t nsupers );
