...
void dgather_l( int_t num_LBlk, int_t knsupc,
               Remain_info_t *L_info,
               double * lval, int_t LD_lval, double * L_buff )
{
    if (num_LBlk < 1)
    {
        return;
...
void dRgather_L( int_t k, int_t *lsub, double *lusup,
...
#ifdef Torch
// Rearragnes and gatehrs L blocks
void dRgather_L_predict( int_t k, int_t *lsub, double *lusup,
                gEtreeInfo_t* gEtreeInfo, Glu_persist_t *Glu_persist,
                gridinfo_t *grid, HyP_t *HyP, int_t *myIperm, int_t *iperm_c_supno )
{
...
void dRgather_U_predict( int_t k, int_t jj0, int_t *usub,	double *uval,
                 double *bigU, gEtreeInfo_t* gEtreeInfo,	
                 Glu_persist_t *Glu_persist, gridinfo_t *grid, HyP_t *HyP,
                 int_t* myIperm, int_t *iperm_c_supno, int_t *perm_u)
{
